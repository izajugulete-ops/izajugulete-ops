...
* **[ESP32 Marvel BLE Bridge]([link-to-your-repo](https://github.com/izajugulete-ops/esp32-ble-wifi-bridge))** * Developing a communication bridge between an **ESP32 microcontroller** and a mobile application via **BLE (Bluetooth Low Energy)**.
